...
EXCLUDE_PATTERN='^./.git/|^./scripts/public-surface-scan.sh|office/schemas/.*\.xsd$|^./docs/PUBLICATION_POLICY.md|^./docs/RELEASE_CHECKLIST.md|^./examples/workflows/release-checklist.md|^./NOW.md|^./.gitignore'
