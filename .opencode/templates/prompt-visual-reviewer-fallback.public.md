# Visual-reviewer-fallback Helper — Personal Projects Workspace

> GENERATED FILE — DO NOT EDIT DIRECTLY.
> Canonical source: .opencode/agents/visual-reviewer-fallback.md
> To regenerate: bash .opencode/scripts/sync-opencode-runtime.sh

# Visual Reviewer (Fallback) - Helper Agent

**Model:** YOUR_PROVIDER/kimi-k2.6 (OpenCode Go premium reserve; provider+model diversity from primary Umans kimi-k2.7 since v4.16)
**Access:** Read-only
...
As the fallback reviewer, you should:
