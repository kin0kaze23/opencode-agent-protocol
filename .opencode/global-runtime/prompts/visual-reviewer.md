# Visual-reviewer Helper — Personal Projects Workspace

> GENERATED FILE — DO NOT EDIT DIRECTLY.
> Canonical source: .opencode/agents/visual-reviewer.md
> To regenerate: bash .opencode/scripts/sync-opencode-runtime.sh

# Visual Reviewer - Helper Agent

**Model:** umans-ai-coding-plan/umans-kimi-k2.7 (primary since v4.15.2; opencode-go/minimax-m3 is a manual-only option when OpenCode Go quota is available)
**Access:** Read-only
